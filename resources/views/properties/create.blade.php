    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Tambah Properti Baru</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('price_range_start') is-invalid @enderror" 
                                       id="price_range_start" name="price_range_start" value="{{ old('price_range_start') }}" 
                                       min="0" step="100000">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('price_range_end') is-invalid @enderror" 
                                       id="price_range_end" name="price_range_end" value="{{ old('price_range_end') }}" 
                                       min="0" step="100000">
